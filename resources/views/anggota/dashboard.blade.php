...
<div class="dashboard-container">
        ...
        <div class="quick-actions-grid animate-slide-up" style="animation-delay: 0.4s">
            <a href="{{ route('anggota.pembelian.katalog') }}" class="action-card blue bg-gradient-to-br from-blue-500 to-blue-600">
            ...
            <a href="{{ route('anggota.simpanan.show') }}" class="action-card green bg-gradient-to-br from-green-500 to-green-600">
                <div class="action-icon">
            ...
            <a href="{{ route('anggota.pembelian.riwayat') }}" class="action-card purple bg-gradient-to-br from-purple-500 to-purple-600">
                <div class="action-icon">
            ...
            <a href="{{ route('anggota.profil.show') }}" class="action-card orange bg-gradient-to-br from-orange-500 to-orange-600">
                <div class="action-icon">
