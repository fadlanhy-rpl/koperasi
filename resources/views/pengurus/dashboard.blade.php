...
<div class="dashboard-container">
    ...
    <div class="quick-actions-grid animate-slide-up" style="animation-delay: 0.4s">
        <a href="{{ route('pengurus.transaksi-pembelian.create') }}" class="action-card blue bg-gradient-to-br from-blue-500 to-blue-600">
        ...
        <a href="{{ route('pengurus.stok.formBarangMasuk', ['barang' => App\Models\Barang::first()?->id ?? 0 ]) }}" class="action-card green bg-gradient-to-br from-green-500 to-green-600">
            <div class="action-icon">
        ...
        <a href="{{ route('pengurus.simpanan.wajib.index') }}" class="action-card purple bg-gradient-to-br from-purple-500 to-purple-600">
            <div class="action-icon">
        ...
        <a href="{{ route('pengurus.laporan.penjualan.umum') }}" class="action-card orange bg-gradient-to-br from-orange-500 to-orange-600">
            <div class="action-icon">
                ...
                <tbody>
                    @forelse($transaksiTerbaruFormatted as $transaksi)
                        <tr>
                            ...
                            <td class="font-semibold text-gray-800">{{ Str::limit($transaksi->anggota_name, 20) }}</td>
