...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laravel\Koperasi\koperasi-1\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laravel\\Koperasi\\koperasi-1\\public\\storage',
...
'login','logout','home','admin.manajemen-pengguna.index',
'admin.manajemen-pengguna.create','admin.manajemen-pengguna.store','admin.manajemen-pengguna.show','admin.manajemen-pengguna.edit','admin.manajemen-pengguna.update',
'admin.manajemen-pengguna.destroy','pengurus.unit-usaha.index','pengurus.unit-usaha.create','pengurus.unit-usaha.store','pengurus.unit-usaha.show',
'pengurus.unit-usaha.edit','pengurus.unit-usaha.update','pengurus.unit-usaha.destroy','pengurus.barang.index','pengurus.barang.create',
'pengurus.barang.store','pengurus.barang.show','pengurus.barang.edit','pengurus.barang.update','pengurus.barang.destroy',
'pengurus.stok.formBarangMasuk','pengurus.stok.storeBarangMasuk','pengurus.stok.formBarangKeluarPenyesuaian','pengurus.stok.storeBarangKeluar','pengurus.stok.storePenyesuaianStok',
'pengurus.stok.histori','pengurus.simpanan.pokok.index','pengurus.simpanan.pokok.store','pengurus.simpanan.wajib.index','pengurus.simpanan.wajib.store',
'pengurus.simpanan.sukarela.index','pengurus.simpanan.sukarela.storeSetoran','pengurus.simpanan.sukarela.storePenarikan','pengurus.simpanan.riwayatAnggota','pengurus.transaksi-pembelian.index',
'pengurus.transaksi-pembelian.create','pengurus.transaksi-pembelian.store','pengurus.transaksi-pembelian.show','pengurus.pembayaran-cicilan.create','pengurus.pembayaran-cicilan.store',
'pengurus.laporan.penjualan.umum','pengurus.laporan.penjualan.perBarang','pengurus.laporan.penjualan.labaRugi','pengurus.laporan.simpanan.rekapTotal','pengurus.laporan.simpanan.rincianPerAnggota',
'pengurus.laporan.simpanan.wajibBelumBayar','pengurus.laporan.stok.daftarTerkini','pengurus.laporan.stok.kartuStok','anggota.profil.show','anggota.profil.edit',
'anggota.profil.update','anggota.profil.updatePassword','anggota.simpanan.show','anggota.pembelian.riwayat','anggota.pembelian.detail',
'storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.laporan.penjualan','admin.laporan.simpanan','admin.laporan.stok','admin.unit_usaha.create',
'admin.unit_usaha.edit','admin.unit_usaha.index','admin.users.create','admin.users.edit','admin.users.index',
'anggota.dashboard','anggota.profil','anggota.riwayat_pembelian.index','anggota.riwayat_pembelian.show','anggota.riwayat_simpanan',
'auth.login','auth.register','components.button','components.card','components.input',
'components.modal','home','layouts.app','layouts.guest','layouts.partials._footer',
'layouts.partials._header','layouts.partials._sidebar_admin','layouts.partials._sidebar_anggota','layouts.partials._sidebar_pengurus','pengurus.barang.create',
'pengurus.barang.edit','pengurus.barang.index','pengurus.cicilan.catat','pengurus.cicilan.riwayat_pembelian','pengurus.dashboard',
'pengurus.laporan.penjualan','pengurus.laporan.stok','pengurus.pembelian.create','pengurus.pembelian.index','pengurus.pembelian.show',
'pengurus.simpanan.catat','pengurus.simpanan.daftar_anggota_simpanan','pengurus.simpanan.riwayat_anggota','pengurus.stok.catat_keluar_penyesuaian','pengurus.stok.catat_masuk',
'pengurus.stok.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
